...
{% asset_img dubbo控制台.png dubbo控制台 %}

在 服务治理/动态配置 查看或修改覆盖规则。

{% asset_img 查看动态配置.png 查看动态配置 %}
...
{% asset_img 创建应用动态配置.png 创建应用动态配置 %}
...
{% asset_img 创建服务动态配置.png 创建服务动态配置 %}



查看provider控制台，动态配置创建成功，如图

{% asset_img 服务配置结果.png 服务配置结果 %}
